...
[%x introduction %] asked whether some programmers are more productive than others.
The answer was "yes",
...
One practice that is frequently mentioned is [%g tdd "test-driven development" %] (TDD):
...
-   Discussion based on <cite>Fucci2016</cite>
    ...
    -   Introduce [%g mann_whitney_u "Mann-Whitney U test" %]
        (also called [%g wilcoxon_rank_sum "Wilcoxon rank sum test" %])
    -   Also introduce [%g effect_size "effect size" %]
